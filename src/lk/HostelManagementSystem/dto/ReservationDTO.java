...
import java.time.LocalDate;
    ...
    public class ReservationDTO {
        ...
        public boolean equals(Object o) {
            if (o == this) {
                return true;
            } else if (!(o instanceof ReservationDTO)) {
                return false;
            } else {
        ...
        public String toString() {
            return "ReservationDTO(res_id=" + this.getRes_id() + ", date=" + this.getDate() + ", student_id=" + this.getStudent_id() + ", room_type_id=" + this.getRoom_type_id() + ", status=" + this.getStatus() + ")";
        }
    }
