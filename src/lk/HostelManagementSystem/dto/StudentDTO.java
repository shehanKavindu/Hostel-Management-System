...
import java.time.LocalDate;
    ...
    public class StudentDTO {
        ...
        public boolean equals(Object o) {
            if (o == this) {
                return true;
            } else if (!(o instanceof StudentDTO)) {
                return false;
            } else {
        ...
        protected boolean canEqual(Object other) {
            return other instanceof StudentDTO;
        }
        ...
        public String toString() {
            return "StudentDTO(student_id=" + this.getStudent_id() + ", name=" + this.getName() + ", address=" + this.getAddress() + ", contact_no=" + this.getContact_no() + ", dob=" + this.getDob() + ", gender=" + this.getGender() + ")";
        }
    }
